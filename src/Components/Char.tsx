...
const Charecteristics = (props: Props) => {
  return (
    <div className="flex flex-wrap justify-center items-center my-4 gap-y-3 gap-x-3 ">
      <button className="flex btn  px-7 py-2 bg-base-200 w-max items-center gap-x-2 rounded-none ">
