...
const SaleTime = () => {
  ...
  return (
    <div className="bg-[#f6f6f6] mt-6 mb-6  relative overflow-hidden">
      <div className="flex flex-col gap-y-5 justify-center items-center h-[80vh]">
        ...
        <p className="px-10 lg:px-72 text-base font-light text-center">
      ...
      <div className="hidden lg:flex items-start absolute top-0 -left-3">
        <Image src={"/h-1.jpg"} alt="img" width={300} height={800} />
      </div>
      <div className="hidden lg:flex items-end absolute top-0 -right-3">
        <Image src={"/h-1.jpg"} alt="img" width={300} height={800} />
      </div>
    </div>
  );
